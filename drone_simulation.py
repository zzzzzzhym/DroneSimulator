...
class DroneSimulator:
    ...
    def plot_disturbance_force(self):
        ...
        axs[0, 0].plot(self.t_span, self.logger_np["f_disturb"][:, 0], marker='x')
        axs[0, 0].plot(self.t_span, self.logger_np["f_disturb_est"][:, 0], marker='x')
        axs[0, 0].set_ylabel("f_x")
        axs[0, 0].legend(['f_disturb', 'f_disturb_est'])
        axs[1, 0].plot(self.t_span, self.logger_np["f_disturb"][:, 1], marker='x')
        axs[1, 0].plot(self.t_span, self.logger_np["f_disturb_est"][:, 1], marker='x')
        axs[1, 0].set_ylabel("f_y")
        axs[1, 0].legend(['f_disturb', 'f_disturb_est'])
        axs[2, 0].plot(self.t_span, self.logger_np["f_disturb"][:, 2], marker='x')
        axs[2, 0].plot(self.t_span, self.logger_np["f_disturb_est"][:, 2], marker='x')
        axs[2, 0].set_ylabel("f_z")
        axs[2, 0].legend(['f_disturb', 'f_disturb_est'])
        axs[3, 0].plot(self.t_span, f_norm, marker='x')
        axs[3, 0].plot(self.t_span, f_est_norm, marker='x')
        axs[3, 0].set_ylabel("f_norm")
        axs[0, 1].plot(self.t_span, self.logger_np["torque_disturb"][:, 0], marker='x')
        axs[0, 1].plot(self.t_span, self.logger_np["torque_disturb_est"][:, 0], marker='x')
        axs[0, 1].set_ylabel("torque_x")
        axs[1, 1].plot(self.t_span, self.logger_np["torque_disturb"][:, 1], marker='x')
        axs[1, 1].plot(self.t_span, self.logger_np["torque_disturb_est"][:, 1], marker='x')
        axs[1, 1].set_ylabel("torque_y")
        axs[2, 1].plot(self.t_span, self.logger_np["torque_disturb"][:, 2], marker='x')
        axs[2, 1].plot(self.t_span, self.logger_np["torque_disturb_est"][:, 2], marker='x')
        axs[2, 1].set_ylabel("torque_z")
        axs[3, 1].plot(self.t_span, torque_norm, marker='x')
        axs[3, 1].plot(self.t_span, torque_est_norm, marker='x')
