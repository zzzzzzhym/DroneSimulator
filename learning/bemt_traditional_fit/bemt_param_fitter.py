...
def get_loss(x, datasets: list[data_factory.FittingDataset], blade: FittedBlade, is_in_validation=False):
...
def fit_params(datasets: list[data_factory.FittingDataset], blade: FittedBlade, initial_guess=None):
...
def test_fitted_params(datasets: list[data_factory.FittingDataset], is_in_validation=True):
